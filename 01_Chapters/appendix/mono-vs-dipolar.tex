...
\begin{table}[h]
\centering
\caption{Probe discrimination statistics across all 21 measurement locations.\nota{check values because they were in a random notebook draft, prob correct but recalculate them to double check}}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{../../02_Images/mono_F_matrix_heatmap.png}
...
Fields show diverse orientations and polarity distributions. (Continued on next page)}
\label{fig:dip-cases}
\end{figure}
...
\ContinuedFloat
\centering
\setcounter{subfigure}{20}  % Continue subfigure counter from page 1 (start at 21st)
% Page 2: Remaining 16 dipolar cases
% Row 6: D_e3e9-D_e4e6
\begin{subfigure}{0.23\textwidth}
...
\caption{Electric potential distributions for the 36 dipolar stimulation cases (continued).}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../../02_Images/dip_F_matrix_heatmap.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../../02_Images/mono_correlation_heatmap.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../../02_Images/dip_correlation_heatmap.png}
