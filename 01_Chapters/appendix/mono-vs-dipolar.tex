...
\begin{table}[h]
\centering
\caption{Probe discrimination statistics across all 21 measurement locations. CV (coefficient of variation) quantifies how much probe responses vary across different source configurations; higher CV indicates better spatial discrimination capability.}
...
\caption{Correlation in monopolar protocol. RMS: 0.4056}
\label{fig:mono-corr}
\end{figure}
...
\caption{Correlation in dipolar protocol. RMS: 0.4553}
\label{fig:dip-corr}
\end{figure}

\textbf{Nota para revisión:} El RMS de la correlación entre casos es similar e incluso un poco más alta en el dipolar
