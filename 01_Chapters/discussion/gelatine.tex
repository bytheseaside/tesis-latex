...
Specifically, the phase angle ($\theta$) for the lower concentration solution remains closer to 0 degrees, indicating a predominantly resistive behavior, mainly governed by the bulk material resistance. In contrast, the 5\% formulation exhibits a larger phase shift (moving away from 0 degrees). This increased capacitive reactance is attributable to **interfacial polarization**.
