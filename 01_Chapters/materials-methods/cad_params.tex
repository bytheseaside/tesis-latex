...
\begin{table}[h!]
    ...
    \begin{tabular}{l c p{7cm}}
        ...
        \texttt{shellThickness\_MeasRegion} & 3.2 mm & Wall thickness of the shell in the measuring region; chosen for structural rigidity and manufacturability. \\
...
When a parameter is changed in the global \texttt{project\_params} file, all dependent geometries regenerate accordingly; however, Fusion~360 requires each affected component to be manually updated to the latest version within the project for the changes to propagate. 
Once updated, the model remains fully consistent and fabrication-ready without the need for manual geometric edits. 
This parametric structure allows researchers to explore alternative layouts, adapt the phantom to new requirements, or generate revised versions of the design while preserving overall integrity.
