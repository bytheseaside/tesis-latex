...
The output signals were acquired using an EEG electrode connected to a \textbf{OpenBCI Cyton} biosensing board. The signals were visualized and logged using the proprietary OpenBCI GUI to verify frequency accuracy and measure the peak-to-peak voltage attenuation introduced by the medium.
