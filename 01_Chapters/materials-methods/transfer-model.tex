...
\nota{hasta ahora, hablamos de como lo simulamos, desde el punto de vista fisico usando maxwell y propiedades del sistema para obtener lo que se deberia obtener en la realidad, usando FEM asi que es una aproximacion al numero real pero bueno....  ahora lo que sigue usar esas simulaciones, tomandolas como valor real (ponele), y armar un modelo matematico (solo tiene en cuenta lo que dio el simulador), que permita relacionar valores obtenidos en el "cuero cabelludo" con valores enviados a las antenas internas - basicamente armar $V_{cc} = A * V_{antena}$ , sistema matricial, para despues crear una pseudoinversa (solo algunas de las columnas de A pasan a la pseudoinversa... no todas, hay que usar algun criterio para ver cuales son las "mejores") y dado cualquier $V_{cc}$ que se quiera obtener, saber cual es el $V_{antena}$ a enviar al fantoma... }
