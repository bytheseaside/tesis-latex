...
For the Dirichlet--Dirichlet (DD) family, nontrivial radial potential gradients develop across the domain, including across the material interface at $r = r_1$.
These configurations therefore expose multiple numerical features suitable for validation throughout the full computational volume, with particular attention to
regions near the material interface.
