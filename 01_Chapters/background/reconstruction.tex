...
and \textit{inverse} problems. A forward problem follows the deductive application of
governing physical laws—such as those of electromagnetism, mechanics, or physiology—to
a known set of inputs or system parameters in order to predict observable outcomes
\cite{mueller-2012}. Forward problems are typically well posed, admitting solutions that
are unique and stable with respect to perturbations in the input data \cite{burger}.

In electroencephalography, a forward formulation commonly consists of computing scalp
potentials at specified locations given a prescribed distribution of internal sources.
In phantom-based systems, the forward problem instead consists of predicting surface
voltage measurements resulting from known actuator excitations applied within the
phantom.
