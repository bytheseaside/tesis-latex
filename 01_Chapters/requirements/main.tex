...
\nota{Ponemos esto antes de Materiales y Métodos porque define qué se quiere lograr con el proyecto? No sé si mergearlo con Objetivos sino}
...
\begin{itemize}
    \item \textbf{Cost-Effectiveness:} The solution must provide a low-cost alternative to commercial EEG simulators, utilizing standard PC hardware and accessible components.
...
\begin{itemize}
    \item \textbf{FR-07 Signal Traduction Validation:} The solution must provide validation of the signal injection.
