...
\nota{ BORRAR DESPUES DE INTEGRAR EN INTRO, muy sutilmente, no poner punto por punto como está aca}
The following high-level constraints guide the project development:
\begin{itemize}
    \item \textbf{Cost-Effectiveness:} The solution must provide a cost-effective alternative to commercial \gls{eeg} simulators, utilizing standard PC hardware and accessible components.
