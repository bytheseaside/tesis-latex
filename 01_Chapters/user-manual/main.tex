...
This mode synthesizes artificial EEG signals for hardware verification and educational demonstration. It allows for the independent manipulation of frequency, amplitude, and waveform topology for all 8 channels.
\begin{itemize}
    \item \textbf{Waveform Selection:} Select the desired topology (e.g., Alpha) from the module dropdown. The system automatically snaps the frequency range to the standard EEG band that corresponds to the selected waveform.
