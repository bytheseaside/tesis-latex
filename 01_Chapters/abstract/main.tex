...
Experimental validation was conducted using homogeneous gelatine-based prototypes, including the assembly and testing of a full-scale Open EEG Phantom model. Signal injection experiments confirmed successful propagation of controlled waveform patterns through the conductive medium, with measurable surface potentials validating the effectiveness of the audio-based transduction approach and the suitability of the selected materials for phantom construction.
